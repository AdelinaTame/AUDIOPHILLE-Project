...
const clickZx9SpeakersButton = document.getElementById('button1');
const clickZx7SpeakersButton = document.getElementById('button2');

const h1RemoveElement = document.querySelector('.speakers-title');
...
const bigBoxModifyDimension = document.querySelector('.zx9SpeakersText');
const cart = document.querySelector('.cart');

const removeElem1 = document.querySelector('.zx7-speakers');
...
const changeTitle1 = document.querySelector('.zx9-h1');
const speakersZx9Image = document.querySelector('.zx9SpeakersImage');
...
function addInLocalStorage1(nameOfProductParam) {
    ...
    if (nameOfProductParam === "ZX9 SPEAKER") {
...
function modifySpeakersPage(nameOfProduct) {
    ...
    linkGoBack.setAttribute('href', '../PROJECT/desktop-category-speakers.html');
    ...
    image3.setAttribute('src', '../PROJECT/images/product-xx59-headphones/desktop/image-product.jpg');
    ...
    button3.setAttribute("id", "button3Modify");
    ...
    if (nameOfProduct === "ZX9 SPEAKER") {
        ...
        _listener1 = () => { modifySpeakersPage("ZX7 SPEAKER") };
        button1Modify.addEventListener("click", _listener1);

        ///buttonul 2
        const getButton2 = document.getElementById("button2Modify");
        ...
        ///buttonul 3
        const getButton3 = document.getElementById("button3Modify");
        ...
        list2itemInTheBox1Modify.innerHTML = 'Speaker Unit';
        const list2itemInTheBox2Modify = document.getElementById("list2itemInTheBox2Modify");
        list2itemInTheBox2Modify.innerHTML = 'Speaker Cloth Panel';
    ...
    else if (nameOfProduct === "ZX7 SPEAKER") {
        ...
        button1Modify.removeEventListener("click", _listener5);
        button1Modify.removeEventListener("click", _listener6);
        _listener1 = () => { modifySpeakersPage("ZX9 SPEAKER") };
        button1Modify.addEventListener("click", _listener1);
        ...
        changeTitle1.innerHTML = 'ZX7 SPEAKER';
        speakersZx9Image.setAttribute("src", "../PROJECT/images/product-zx7-speaker/desktop/image-category-page-preview.jpg");
        speakersZx9Image.setAttribute('alt', 'zx7');
        changeTextMark1.innerHTML = 'Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.';
        const priceSelectableProduct = document.getElementById("priceSelectableProduct");
        priceSelectableProduct.innerHTML = '$ 3,500';
        subtitleNewProduct.remove();

        const pargraphBoxModify = document.getElementById("pargraphBoxModify");
        pargraphBoxModify.innerHTML = 'Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response rate and excellent high frequencies that lower tiered bookshelf speakers cannot provide. The woofers are made from aluminum that produces a unique and clear sound. XLR inputs allow you to connect to a mixer for more advanced usage. <br><br>The ZX7 speaker is the perfect blend of stylish design and high performance. It houses an encased MDF wooden enclosure which minimises acoustic resonance. Dual connectivity allows pairing through bluetooth or traditional optical and RCA input. Switch input sources and control volume at your finger tips with the included wireless remote. This versatile speaker is equipped to deliver an authentic listening experience.';
        ...
        list2itemInTheBox3Modify.innerHTML = 'User Manual';
        const list2itemInTheBox4Modify = document.getElementById("list2itemInTheBox4Modify");
        list2itemInTheBox4Modify.innerHTML = '3.5mm 7.5m Audio Cable';
        const list2itemInTheBox5Modify = document.getElementById("list2itemInTheBox5Modify");
        if (list2itemInTheBox5Modify != null) {
            list2itemInTheBox5.innerHTML = '7.5m Optical Cable';
        }

        const imgGallery1Modify = document.getElementById("imgGallery1Modify");
        imgGallery1Modify.setAttribute('src', '../PROJECT/images/product-zx7-speaker/desktop/image-gallery-1.jpg');
        imgGallery1Modify.setAttribute('alt', 'imgGallery1Modify');

        const imgGallery2Modify = document.getElementById("imgGallery2Modify");
        imgGallery2Modify.setAttribute('src', '../PROJECT/images/product-zx7-speaker/desktop/image-gallery-2.jpg');
        imgGallery2Modify.setAttribute('alt', 'imgGallery2Modify');

        const imgGallery3Modify = document.getElementById("imgGallery3Modify");
        imgGallery3Modify.setAttribute('src', '../PROJECT/images/product-zx7-speaker/desktop/image-gallery-3.jpg');
        imgGallery3Modify.setAttribute('alt', 'imgGallery3Modify');

        const image1Modify = document.getElementById("image1Modify");
        image1Modify.setAttribute('src', '../PROJECT/images/product-zx9-speaker/desktop/image-category-page-preview.jpg');
        image1Modify.setAttribute('alt', 'image1Modify');

        const youMayAlsoLikeTitle1 = document.getElementById("youMayAlsoLikeTitle1");
        youMayAlsoLikeTitle1.innerHTML = 'ZX9 SPEAKER';

        const image2Modify = document.getElementById("image2Modify");
        image2Modify.setAttribute('src', '../PROJECT/images/product-xx99-mark-one-headphones/desktop/image-product.jpg');
        image2Modify.setAttribute('alt', 'image2');
...
//Aici se termina functia modify
/////////////////////////////////////////////////////////////////////////////////////////////////////////////

if (localStorage.getItem("speakerSeeProduct") != null) {
    if (localStorage.speakerSeeProduct === "1") {
        localStorage.speakerSeeProduct = 0;
        modifySpeakersPage("ZX9 SPEAKER");
    }
}

if (localStorage.getItem("speakerSeeProduct2") != null) {
    if (localStorage.speakerSeeProduct2 === "1") {
        localStorage.speakerSeeProduct2 = 0;
        modifySpeakersPage("ZX7 SPEAKER");
    }
}

if(clickZx9SpeakersButton!=null){
    clickZx9SpeakersButton.addEventListener('click', () => modifySpeakersPage("ZX9 SPEAKER"));
}

if(clickZx7SpeakersButton!=null){

    clickZx7SpeakersButton.addEventListener('click', () => modifySpeakersPage("ZX7 SPEAKER"));
}
